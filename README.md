...
| Type          | bool                                                                                               |
| Default value | false                                                                                              |
| Use case      | If you want to check if the error message displays correctly in your GUI, set this flag to `true`. |
...
| Type        | bool                                                                     |
| Is required | Yes                                                                      |
| Note        | Used for logging only. "Gateway" could be called "service" in your code. |
